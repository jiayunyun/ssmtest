      ...
      ${paginationInfo}
        ...
        ${this.constants.html.pageDropdown[0]}`]
            ...
            pageList.forEach((page, i) = > {
                if(
            !o.smartDisplay || i === 0 || pageList[i - 1] < o.totalRows
        )
            {
                let active
                if ($allSelected) {
        ...
        >
            Utils.sprintf(this.constants.html.paginationItem,
