...
.
    addrbarInit = true
    const
    _prefix = this.options.addrPrefix || ''
...
.
    options
.
    pageNumber = +_GET(`${_prefix}page`) || $.BootstrapTable.DEFAULTS.pageNumber
    this
.
    options
.
    pageSize = +_GET(`${_prefix}size`) || $.BootstrapTable.DEFAULTS.pageSize
    this
.
    options
.
    sortOrder = _GET(`${_prefix}order`) || $.BootstrapTable.DEFAULTS.sortOrder
    this
.
    options
.
    sortName = _GET(`${_prefix}sort`) || $.BootstrapTable.DEFAULTS.sortName
    this
.
    options
.
    searchText = _GET(`${_prefix}search`) || $.BootstrapTable.DEFAULTS.searchText

    const
    _onLoadSuccess = this.options.onLoadSuccess
