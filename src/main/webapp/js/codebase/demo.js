$(function () {
    ...
    var oLiveView = {
        ...
        szPassword: "admin123",	// device password
    ...
    WebVideoCtrl.I_Login(oLiveView.szIP, oLiveView.iProtocol, oLiveView.szPort, oLiveView.szUsername, oLiveView.szPassword, {
        success: function (xmlDoc) {
            ...
            arrXml.push("<RecordPath>" + videoPath + "</RecordPath>");
            arrXml.push("<PackgeSize>2</PackgeSize>");
            arrXml.push("</LocalConfigInfo>");
            //alert(arrXml);
            //设置录像文件名称
            WebVideoCtrl.I_SetLocalCfg(arrXml.join(""));
            var szFileName = oLiveView.szIP + "_" + oLiveView.iChannelID + "_" + new Date().getTime();
            //开始录像
